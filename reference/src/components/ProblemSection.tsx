...
export default function ProblemSection() {
  ...
  return (
    <>
      {/* Sit above hero absolutely-positioned bleed so the strip is never painted under */}
      ...
      >
        ...
        <div className="relative mx-auto max-w-[1600px] px-5 md:px-10">
          <div
            className="relative border-l border-[color-mix(in_srgb,var(--teal)_28%,transparent)] pl-5 md:pl-8"
          >
          ...
          <div className="mb-20 grid grid-cols-1 gap-8 lg:grid-cols-[minmax(0,0.5fr)_minmax(0,1fr)] lg:gap-20 md:mb-24">
            ...
            <div className="lg:pt-8">
              <p className="prob-subhead max-w-[42ch] font-body text-[16px] leading-[1.72] text-[var(--text-dim)]">
                They&apos;re comparing you to the last premium experience their money bought — Apple Store, architecture firm, luxury hotel. That&apos;s the benchmark. Not your competitor down the street.
              </p>
            </div>
          </div>

          {/* ── Problem rows — editorial ──────────────── */}
            ...
            {problems.map((p, i) => (
              ...
              >
                ...
                <div className="prob-pull flex items-start">
                  <p
                    className="font-display italic tracking-[-0.015em] text-[var(--text-dim)] opacity-35 group-hover:opacity-55 transition-opacity duration-400"
                    style={{ fontSize: "clamp(1rem,1.6vw,1.3rem)", fontWeight: 400, lineHeight: 1.3, whiteSpace: "pre-line" }}
                  >
                    {p.pull}
                  </p>
                </div>

                {/* Horizontal accent line on highlighted row */}
                {i === 2 && (
                  <div
