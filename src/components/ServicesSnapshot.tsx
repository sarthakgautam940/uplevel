        ...
        <div className="mb-12 grid grid-cols-1 gap-8 border-b border-[var(--border)] pb-12 md:mb-14 md:grid-cols-12 md:items-start md:gap-10 md:pb-14">
          <div className="md:col-span-5 lg:col-span-4">
            <p className="font-body text-[13px] font-normal leading-[1.6] tracking-[-0.01em] text-[var(--text-dim)]">
              ...
              page — version here, two entry points, one bold standard.
            </p>
          </div>
          <div className="md:col-span-7 md:sticky md:top-[min(26vh,9rem)] md:z-[1] lg:col-span-8">
            <h2
        ...
        <div className="grid grid-cols-1 gap-5 lg:grid-cols-2 lg:gap-8">
          ...
          >
            ...
            <div className="relative z-[1] mt-auto flex flex-wrap items-end justify-between gap-4 border-t border-[var(--border)] pt-6">
              <div>
                <p className="font-body text-[10px] font-medium uppercase tracking-[0.2em] text-[var(--text-dim)]/70">
                  One-time
                </p>
                <p
                  className="font-display tabular-nums tracking-[-0.02em] text-[var(--text)]"
                  style={{ fontSize: "clamp(1.4rem,2.4vw,1.85rem)" }}
                >
                  {tierPrimary.price}
                  <span className="ml-2 font-body text-[13px] font-normal text-[var(--text-dim)]">
                    {tierPrimary.monthly}
                  </span>
                </p>
              </div>
